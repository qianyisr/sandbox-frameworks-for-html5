(function(require, exports, module) {
    ...
    var query = (function(window) {
        ...
        var $afm = function(toSelect, what) {
            ...
            if (!toSelect) {
            ...
            } else if ($.isArray(toSelect) && toSelect.length != nundefined) { //Passing in an array or object
                ...
                return this;
            } else if ($.isObject(toSelect) && what == nundefined) { //Single object
                this[this.length++] = toSelect;
                return this;
        ...
        */
        $.ajax = function(opts) {
            ...
            try {
                 ...
                 * by lien 全局ajax请求头部
                 */
                if (typeof _ajaxSettings === "function")
                    settings.headers = $.extend(
                        _ajaxSettings, 
                        settings.headers
                    );
